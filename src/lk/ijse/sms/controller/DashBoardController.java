...
public class DashBoardController implements Initializable {
    ...
    public DashBoardController() {
        ...
        batchBO = AppInitilaizer.ctx.getBean(BatchBO.class);
        moduleBO = AppInitilaizer.ctx.getBean(ModuleBO.class);
        courseBO  = AppInitilaizer.ctx.getBean(CourseBO.class);
        studentBO = AppInitilaizer.ctx.getBean(StudentBO.class);
