...
import lk.ijse.sms.main.AppInitilaizer;
...
public class ManageCourseController implements Initializable {
    ...
    public ManageCourseController() {
        registerCourse= AppInitilaizer.ctx.getBean(RegisterCourseBO.class);
        courseModuleBO  = AppInitilaizer.ctx.getBean(CourseModuleBO.class);
        module = AppInitilaizer.ctx.getBean(ModuleBO.class);
        course = AppInitilaizer.ctx.getBean(CourseBO.class);
        exam = AppInitilaizer.ctx.getBean(ExamBO.class);
    }
