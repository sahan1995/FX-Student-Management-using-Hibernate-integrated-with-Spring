...
public class StudentRegistrationController implements Initializable {
    ...
    public StudentRegistrationController() {
        ...
        registrationB  = AppInitilaizer.ctx.getBean(RegistrationBO.class);
        student  = AppInitilaizer.ctx.getBean(StudentBO.class);
        batch = AppInitilaizer.ctx.getBean(BatchBO.class);
